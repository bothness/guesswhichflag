...
<div class="container">
	...
	<div class="flag-container">
		...
		<div class="flag-mini"><img src="https://cdnjs.cloudflare.com/ajax/libs/twemoji/14.0.2/svg/{flag.unicode}.svg" alt="{flag.unicode}"/></div>
		{/each}
	</div>
	...
	<div class="flag"><img src="https://cdnjs.cloudflare.com/ajax/libs/twemoji/14.0.2/svg/{game.questions[game.turn].unicode}.svg" alt="{game.questions[game.turn].unicode}"/></div>
	...
	<div class="flag"><img src="https://cdnjs.cloudflare.com/ajax/libs/twemoji/14.0.2/svg/{game.questions[game.turn - 1].unicode}.svg" alt="{game.questions[game.turn - 1].unicode}"/></div>
...
<div class="flag-container">
		{#each game.answers as answer, i}
		<div class="flag-mini"><img src="https://cdnjs.cloudflare.com/ajax/libs/twemoji/14.0.2/svg/{game.questions[i].unicode}.svg" alt="{game.questions[i].unicode}"/><br/>{answer ? '✔️' : '❌'}</div>
		{/each}
	</div>
